...
struct Col : public Expr {
    ...
    Col(AggType agg_type_, std::string tab_name_, std::string col_name_, std::string alias_, bool agg_star_ = false)
        : tab_name(std::move(tab_name_)), col_name(std::move(col_name_)),
          agg_type(agg_type_), agg_star(agg_star_), alias(std::move(alias_)) {}
};
