...
aggregate:
    ...
    {
        $$ = std::make_shared<Col>(AGG_COUNT, $3->tab_name, $3->col_name, $6);
    }
    |   aggFunc '(' col ')' AS colName
    {
        $$ = std::make_shared<Col>(static_cast<AggType>($1), $3->tab_name, $3->col_name, $6);
    }
    ;
...
order_clause:
      col  opt_asc_desc 
    { 
        $$ = std::make_shared<OrderBy>(std::vector<std::shared_ptr<Col>>{$1},
